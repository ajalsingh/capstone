...
\hl{For more information on the dataset and use case, please see []}
...
Too few hidden layers would represent a linear problem, while additional layers create complexity hence becoming non linear.
