...
k-Nearst Neighbours (k-NN) is a common approach to classification problems. 
This approach classifies objects based on the compuatational distances between samples/values.
